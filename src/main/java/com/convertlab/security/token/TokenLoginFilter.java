...
import com.convertlab.security.token.model.LoginUserReq;
import com.convertlab.security.token.model.LoginUserRes;
...
public class TokenLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain,
        ...
        String token = tokenManager.createToken(user.getUsername(),user.getGrantedAuthorities());
